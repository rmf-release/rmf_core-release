## rmf_core (rolling) - 1.9999.0-8

The packages in the `rmf_core` repository were released into the `rolling` distro by running `/usr/local/bin/bloom-release --rosdistro rolling --track rolling rmf_core` on `Fri, 15 Jan 2021 16:16:36 -0000`
...
- rosdistro version: `1.9999.0-7`
- old version: `1.9999.0-7`
- new version: `1.9999.0-8`
